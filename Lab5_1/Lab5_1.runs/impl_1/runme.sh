...
HD_PWD='C:/Users/LHeysemK/Desktop/CS223/Labs/Lab 5/Lab5_1/Lab5_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sixteen_bit_gray_upcount.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sixteen_bit_gray_upcount.tcl -notrace
