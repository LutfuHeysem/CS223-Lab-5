...
HD_PWD='C:/Users/LHeysemK/Desktop/CS223/Labs/Lab 5/Lab5_1/Lab5_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sixteen_bit_gray_upcount.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sixteen_bit_gray_upcount.tcl
